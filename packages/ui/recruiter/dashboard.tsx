...
import Logo from '../beeyoo-jaune-png.png'
...
import { RecruiterPage } from './page';
...
export const Dashboard = ({ logo, menu, user, children }: DashboardProps) => {
                                                    ...
                                                    >
                                                        <span
                                                            className={cls({
                                                                ...
                                                                'mr-3 h-6 w-6 flex-shrink-0': true,
                                                            })}
                                                            aria-hidden="true"
                                                        ><item.icon className="w-full" /></span>
                                                        {item.name}
                                                    </a>
                                                ))}
                                            </div>
                                    ...
                                    <span className="flex w-full items-center justify-between">
                                        <span className="flex min-w-0 items-center justify-between space-x-3">
                                            ...
                                            <span className="flex min-w-0 flex-1 flex-col">
                                                ...
                                                <span className="truncate text-sm text-gray-500">{user.alias}</span>
                                            </span>
                                        </span>
                                        <ChevronUpDownIcon
